...
variables [semiring R] [add_comm_monoid M] [add_comm_monoid M₂] [add_comm_monoid M₃] [add_comm_monoid M₄]
...
variables [add_comm_group M₄] [semimodule R M₄]
...
lemma zoug : has_scalar R (M →ₗ[R] M) := linear_map.has_scalar
